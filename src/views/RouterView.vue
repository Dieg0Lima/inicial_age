...
const sampleData = [
  {
    ...
    Estagio: "Contrato: Em andamento",
    IniciodoContrato: "2023-01-15",
...
<template>
  <div class="page-container">
    ...
    <div class="subtitle-page">
      <label
        >Experimente realizar a consulta com Nome, CPF, Telefone, Contrato ou ONU</label
      >
    </div>
